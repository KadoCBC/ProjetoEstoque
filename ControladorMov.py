...
from entidades.TipoMovimentacao import TipoMovimentacao
...
class ControladorMov():
    ...
    def incluir_mov(self):
        ...
        movimentacao = Movimentacao(dados_mov["qt_mov"],dados_mov["instituidor"],dados_mov["motivo"],
                                    datetime.today(),dados_mov["codigo"],brinde, TipoMovimentacao(dados_mov["qt_mov"]))
    ...
    def listar_mov(self):
        ...
        for mov in self.lista_mov:
            self.__tela_mov.mostrar_movimento({"brinde": mov.brinde , "tipo": mov.tipo_mov, "qt_mov": mov.qt_mov,
                                                ...
                                                "codigo": mov.codigo, "data": mov.data})
